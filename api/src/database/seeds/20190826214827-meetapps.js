...
const description =
  'O Community Challenge é uma competição global criada pelo Developer Circles from Facebook. Seu desafio é criar um software que utilize pelo menos uma das três tecnologias: React, Spark AR ou Games em HTML5.\n';
...
const meetapps = [
  ...
  {
    id: 3,
    title: 'ReactSP30 - Especial Frontend Week',
    description,
    location,
